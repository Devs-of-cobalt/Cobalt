/****************************************************************************
** Meta object code from reading C++ file 'newitem.h'
**
...
#include <memory>
#include "../../Cobalt/newitem.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'newitem.h' doesn't include <QObject>."
...
static const qt_meta_stringdata_newItem_t qt_meta_stringdata_newItem = {
    {
...
static const uint qt_meta_data_newItem[] = {
...
void newItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<newItem *>(_o);
        (void)_t;
        switch (_id) {
...
const QMetaObject newItem::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_newItem.offsetsAndSize,
    qt_meta_data_newItem,
    qt_static_metacall,
    nullptr,
...
const QMetaObject *newItem::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *newItem::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_newItem.stringdata0))
        return static_cast<void*>(this);
    return QMainWindow::qt_metacast(_clname);
}

int newItem::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
